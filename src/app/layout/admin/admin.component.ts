...
export class AdminComponent implements OnInit {
  ...
  constructor(public menuItems: MenuItems, public translateService: TranslateService, public router: Router) {
    this.selectedContryImage = 'assets/images/flags/usa.png';
    ...
    localStorage.setItem("current-lng", 'en');
  ...
  changeLanguage(flag: string, language: string, code: string): void {
    this.selectedContryImage = flag;
    this.selectedLanguage = language;
    localStorage.setItem("current-lng", code);
    this.translateService.use(code).subscribe(() => {
      // this.router.navigate([this.router.url])
    });
  }
  getMenuItemNameByKey(key, name) {
    var obj: any = this.translateService.get(key);
    return obj != null ? obj.value : name;
  }
}
